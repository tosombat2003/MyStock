...
import 'main.dart';
import 'menu_stock.dart';
import 'menu_admin.dart';

class HomeAdminScreen extends StatefulWidget {
  final int userId;
  const HomeAdminScreen({super.key, required this.userId});

  @override
  HomeAdminScreenState createState() => HomeAdminScreenState();
}

class HomeAdminScreenState extends State<HomeAdminScreen> {
...
// คลัง 3 (สร้างเพิ่มได้เลย ไม่ต้องสร้างไฟล์ใหม่แล้ว!)
            _buildButton(
                context,
                'ห้องเย็น',
                Colors.teal,
            ...
            _buildButton(context, 'Admin', Colors.purple, MenuAdminScreen()),
          ],
        ),
      ),
    );
